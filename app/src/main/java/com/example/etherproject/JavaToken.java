...
public class JavaToken extends Contract {
    ...
    public static JavaToken load(String contractAddress, Web3j w3, DefaultGasProvider defaultGasProvider) {
        return null;
    }

    public static JavaToken load(String s, Web3j mWeb3j, Credentials mCredentials, BigInteger gasPrice, BigInteger gasLimit) {
        return null;
    }
    ...
    @Deprecated
    public static JavaToken load(String s, Web3j web3j, BigInteger gasPrice, BigInteger gasLimit) {
